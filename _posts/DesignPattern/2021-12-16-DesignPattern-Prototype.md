...
프로토타입 패턴은 기존 인스턴스를 복제해서 새로운 인스턴스를 만들어내는 패턴을 말합니다.



## 1. 의의

[![Untitled](https://github.com/Nelmm/DesignPattern/raw/0e086d54599ae73d0f5b0a4785d69baa1c9fed27/%EA%B0%9D%EC%B2%B4%EC%83%9D%EC%84%B1/3%EC%A3%BC%EC%B0%A8-%ED%94%84%EB%A1%9C%ED%86%A0%ED%83%80%EC%9E%85/img/Untitled.png)](https://github.com/Nelmm/DesignPattern/blob/0e086d54599ae73d0f5b0a4785d69baa1c9fed27/객체생성/3주차-프로토타입/img/Untitled.png)

- https://refactoring.guru/design-patterns/prototype

만약 내부에 private 변수 처리가 되어있다면 기존 인스턴스를 외부만 보고 완전히 복사하는 것은 불가능합니다.

때문에 `DB/Network에서 가져온 객체들을 복사해서 새로운 인스턴스를 만들고 변경해서 사용하면 자원을 아낄 수 있지 않을까?`라는 물음으로 출발하여 **원래 만들어 놓은 객체를 바탕으로 반복적으로 재사용할 수 있게 만든게 이 프로토타입 패턴의 큰 맥락**이라고 할 수 있습니다.

[![Untitled](https://github.com/Nelmm/DesignPattern/raw/0e086d54599ae73d0f5b0a4785d69baa1c9fed27/%EA%B0%9D%EC%B2%B4%EC%83%9D%EC%84%B1/3%EC%A3%BC%EC%B0%A8-%ED%94%84%EB%A1%9C%ED%86%A0%ED%83%80%EC%9E%85/img/Untitled%201.png)](https://github.com/Nelmm/DesignPattern/blob/0e086d54599ae73d0f5b0a4785d69baa1c9fed27/객체생성/3주차-프로토타입/img/Untitled 1.png)





## 2. 자바가 프로토 타입을 제공하는 방식

객체를 복사해주는 `clone`메서드는 `object`에 이미 존재합니다. 하지만 `protected`로 처리되어있어서 아쉽게도 그냥 쓸수는 없다는 문제점이 있습니다.
...
`clone` 메서드를 사용하려면 `cloneable` interface를 상속받아야 하는데, `Object` 클래스에 따로 상속되어 있지 않기 때문에 `Cloneable`을 상속 받는다면 `clone`메서드를 사용할 수 있습니다.
